...
urlpatterns = [
    ...
    path(
        "subject_wise_report/<int:subject_id>/<int:batch_id>/",
        hod_subject_wise_report,
        name="hod_subject_wise_report",
    ),
    path(
        "view_student_details/<int:student_id>/",
        view_student_details,
        name="view_student_details",
    ),
    path("hod_view_my_subject/", hod_view_my_subject, name="hod_view_my_subject"),
    path(
        "hod_update_class/<int:batch_id>/<int:subject_id>/",
        hod_update_class,
        name="hod_update_class",
    ),
    path(
        "hod_my_subject_attendance/<int:batch_id>/<int:subject_id>/",
        hod_my_subject_add_attendance,
        name="hod_my_subject_add_attendance",
    ),
    path(
        "hod_my_subject_internal/<int:batch_id>/<int:subject_id>/",
        hod_my_subject_add_internal,
        name="hod_my_subject_add_internal",
    ),
    path(
        "hod_my_subject_internal_result/<int:batch_id>/<int:subject_id>/",
        hod_my_subject_view_internal_result,
        name="hod_my_subject_view_internal_result",
    ),
    path(
        "hod_my_subject_view_attendance/<int:record_id>/<int:batch_id>/<int:subject_id>/",
        hod_my_subject_view_attendance,
        name="hod_my_subject_view_attendance",
    ),
]
